...
Function helpers {Set-Location "$repos\TtuHelpers"}
...
{
    Copy-Item $personaltools\Microsoft.PowerShell_profile.ps1 -Destination "$env:USERPROFILE\Documents\WindowsPowerShell";
    Copy-Item $personaltools\Microsoft.PowerShell_profile.ps1 -Destination "$env:USERPROFILE\Documents\PowerShell";
}
